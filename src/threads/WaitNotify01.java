...
public class WaitNotify01 {
    ...
    Wait and notify methods allow communication between threads - Recommended!!

    They can only be used on monitored objects (synchronised) otherwise they throw exception
    ...
    public static void main(String[] args) {
        ...
        WaitNotify01 obj = new WaitNotify01(); // need to create object because deposit and withdraw are object/instance methods (non-static methods)
